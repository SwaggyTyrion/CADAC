...
//011129 Adapted to MISSILE6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
void Missile::tabout_banner(ofstream &ftabout,char *title,int &nmonte,int &nmc)
{
	char *buff1;
	char buff2[15];
	int label_length=14;
...
//011129 Adapted to MISSILE6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
Packet Missile::loading_packet_init(int num_missile,int num_aircraft,int num_rocket,int num_radar)
{
	string id;
	char object[4];
...
//011129 Adapted to MISSILE6 simulation, PZi
///////////////////////////////////////////////////////////////////////////////
Packet Missile::loading_packet(int num_missile,int num_aircraft,int num_rocket,int num_radar)
{
	int index;
	int i(0);
...
// from the data files and stores them in 'Missile::Datadeck aerotable' and 
// 'Missile::Datadeck proptable'. In the modules, table look up is carried out by 
