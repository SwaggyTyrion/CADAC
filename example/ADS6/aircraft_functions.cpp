...
///////////////////////////////////////////////////////////////////////////////
Packet Aircraft::loading_packet_init(int num_missile,int num_aircraft,int num_rocket,int num_radar)
{
	string id;
	char object[4];
...
//010207 Created by Peter H Zipfel
///////////////////////////////////////////////////////////////////////////////
Packet Aircraft::loading_packet(int num_missile,int num_aircraft,int num_rocket,int num_radar)
{
	int index(0);
	int i(0);
