...
int const CHARL=300;					//character numbers in a line
...
int const NROCKET=175;					//size of 'rocket' module-variable array
int const NAIRCRAFT=60;					//size of 'aircraft' module-variable array
int const NFLAT0=20;					//size of 'flat3' module-variable array 
int const NRADAR=50;					//size of 'rocket' module-variable array
