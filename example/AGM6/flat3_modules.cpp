...
//080606 Inserted fixed target option, PZi
///////////////////////////////////////////////////////////////////////////////
...
void Flat3::def_kinematics()
{
	...
	flat3[0].init("time",0,"Vehicle time since launch - s","kinematics","exec","com");
	flat3[1].init("launch_delay",0,"Delay of vehicle launch since sim start - s","kinematics","exec","");
	flat3[2].init("launch_epoch",0,"'sim_time' at launch - s","kinematics","exec","");
	flat3[3].init("launch_time",0,"Elapsed time since launch - s","kinematics","exec","");
}
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
void Flat3::environment(double dummy)
{	
	//local variables
	double tempk(0);
...
void Flat3::def_newton()
{
	...
	flat3[25].init("dvae",0,"Vehicle speed - m/s","newton","init/out","");
	...
	flat3[29].init("psivlx",0,"Vehicle heading angle - deg","newton","init/diag","com");
	flat3[30].init("thtvlx",0,"Vehicle flight path angle - deg","newton","init/diag","com");
	...
	flat3[36].init("alt",0,"Vehicle altitude","newton","out","com");
}
///////////////////////////////////////////////////////////////////////////////
