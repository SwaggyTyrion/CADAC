...
void Missile::def_ins()
{
	...
	missile[314].init("ehbe",0,"Altimeter error - m","ins","out","plot");
	...
	missile[324].init("EWBEB",0,0,0,"Error in angular vel of body wrt earth - rad/s","ins","dia","plot");
	missile[325].init("EFSPB",0,0,0,"Error in specific force on body in body coor - N/kg","ins","dia","plot");
	...
	missile[346].init("EVBE",0,0,0,"INS vel error - m/s","ins","state","plot");
	missile[347].init("ESTTCD",0,0,0,"INS pos error derivative - m","ins","state","");
	missile[348].init("ESTTC",0,0,0,"INS pos error - m","ins","state","plot");
}	
///////////////////////////////////////////////////////////////////////////////
